...
function ActionDetails() {
  ...
  const allPhotos =
    action.galerieParAnnee?.flatMap((g) => g.photos) || action.galerie || [];
          ...
          <div style={{ gridColumn: "span 2" }}>
            ...
            <section style={styles.infoGrid}>
              <div style={styles.infoItem}>
                <div style={styles.label}>
                  <Users2 size={16} /> Public Visé
                </div>
                <div style={{ fontFamily: "var(--font-3)", fontWeight: "600" }}>
                  {action.infosPratiques?.public ||
                    action.public ||
                    "Tout public"}
                </div>
              </div>
              <div style={styles.infoItem}>
                <div style={styles.label}>
                  <HelpCircle size={16} /> Prix / Accès
                </div>
                <div style={{ fontFamily: "var(--font-3)", fontWeight: "600" }}>
                  {action.infosPratiques?.prix || "Gratuit / Libre"}
                </div>
              </div>
              <div style={styles.infoItem}>
                <div style={styles.label}>
                  <Clock size={16} /> Fréquence
                </div>
                <div style={{ fontFamily: "var(--font-3)", fontWeight: "600" }}>
                  {action.frequence_detail || action.freq}
                </div>
              </div>
              <div style={styles.infoItem}>
                <div style={styles.label}>
                ...
                <div style={{ fontFamily: "var(--font-3)", fontWeight: "600" }}>
                  {action.infosPratiques?.lieu || action.lieu || "La Réunion"}
                </div>
              </div>
            </section>
            ...
            <section style={styles.card}>
              <h2 style={styles.sectionTitle}>
                <Target size={26} color={accentColor} /> Pourquoi cette action ?
              </h2>
              <div
                style={{
                  display: "grid",
            ...
            <section style={styles.card}>
              <h2 style={styles.sectionTitle}>
                <Info size={26} color={accentColor} /> Description de l'action
              </h2>
              <p
                style={{
                  fontSize: "1.1rem",
                      ...
                      <div style={styles.galleryGrid}>
                        {group.photos.map((img, idx) => (
                          <img
                            ...
                            onClick={() =>
                              setActivePhoto(allPhotos.indexOf(img))
                            }
                            alt=""
                          />
                        ))}
            ...
            {action.videos && (
              <section style={styles.card}>
                <h2 style={styles.sectionTitle}>
                  <PlayCircle size={26} color={accentColor} /> Vidéos de
                  l'action
                </h2>
                <div
                  style={{
          ...
          <aside style={{ position: "sticky", top: "20px" }}>
            ...
            >
              ...
              <div style={{ padding: "20px 0" }}>
                ...
                >
                  {action.bilan2026?.participants || "0"}
                </div>
                <div
                  style={{
                    fontSize: "0.7rem",
            ...
            {action.presse && (
              <div style={styles.card}>
                <h3 style={{ ...styles.sectionTitle, fontSize: "1.2rem" }}>
                  <Newspaper size={22} color={accentColor} /> Dans la presse
                </h3>
            ...
            <div style={styles.card}>
              ...
              >
                <Heart size={22} color={accentColor} /> Financeurs
              </h3>
              <div
                style={{
                  display: "flex",
            ...
            <div style={styles.card}>
              <h3 style={{ ...styles.sectionTitle, fontSize: "1.2rem" }}>
                <Download size={22} color={accentColor} /> Documents
              </h3>
